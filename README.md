...
- 🚫 **Без авто-подписки на Steam-группу ASF** — отключается автоматически при запуске.
...
<div align="center">
<sub>BetterASF — неофициальная надстройка над ArchiSteamFarm. ASF © JustArchiNET.</sub>
</div>
